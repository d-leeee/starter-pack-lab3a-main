...
int main() {
  ...
  // CODETURD: The standard for code review is that you must
  // CODETURD: check that input succeeded before you use it.
  // CODETURD: That standard is met with just this one check
  if (not cin) {
